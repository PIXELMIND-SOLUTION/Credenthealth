...
//       return 'http://31.97.206.144:4051$profileImage';
//     }
//     return null;
//   }
...
class ProfileModel {
  ...
  Map<String, dynamic> toApiJson() {
    ...
    if (mobileNumber != null && mobileNumber!.isNotEmpty) json['mobileNumber'] = mobileNumber;
    if (age != null) json['age'] = age;
    if (gender != null && gender!.isNotEmpty) json['gender'] = gender;
    if (profileImage != null && profileImage!.isNotEmpty) json['profileImage'] = profileImage;
    if (staffId != null && staffId!.isNotEmpty) json['staffId'] = staffId;
  ...
  String? get fullProfileImageUrl {
    if (profileImage != null && profileImage!.isNotEmpty) {
      ...
      // If it starts with a slash, construct the full URL
      else if (profileImage!.startsWith('/')) {
        return 'http://31.97.206.144:4051$profileImage';
      }
      // If it doesn't start with a slash, add one and construct the URL
      else {
        return 'http://31.97.206.144:4051/$profileImage';
      }
    }
  ...
  // Helper method to check if profile has an image
  ...
  // Helper method to get display mobile
  String get displayMobile {
    return mobileNumber ?? 'No mobile number provided';
  }

  // Helper method to get display age
  String get displayAge {
    return age?.toString() ?? 'Not specified';
  }
  ...
  @override
  String toString() {
    return 'ProfileModel(id: $id, name: $name, email: $email, mobileNumber: $mobileNumber, age: $age, gender: $gender, profileImage: $profileImage, fullProfileImageUrl: $fullProfileImageUrl, staffId: $staffId)';
  }
