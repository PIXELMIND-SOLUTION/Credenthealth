...
class Booking {
  ...
  // NEW FIELDS ADDED FROM JSON
  final String? bookingId;
  final BookedSlot? bookedSlot;
  final String? doctorConsultationBookingId;
  final String? diagnosticBookingId;
  ...
  Booking({
    ...
    this.bookingId,
    this.bookedSlot,
    this.doctorConsultationBookingId,
    this.diagnosticBookingId,
    this.diagnostic,
    this.package,
    this.patient,
    this.doctor,
  ...
  factory Booking.fromJson(Map<String, dynamic> json) {
    return Booking(
      ...
      bookedSlot: json['bookedSlot'] != null 
          ? BookedSlot.fromJson(json['bookedSlot']) 
          : null,
      doctorConsultationBookingId: json['doctorConsultationBookingId'],
      diagnosticBookingId: json['diagnosticBookingId'],
      diagnostic: json['diagnostic'] != null 
          ? DiagnosticInfo.fromJson(json['diagnostic']) 
          : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'doctorConsultationBookingId': doctorConsultationBookingId,
      'diagnosticBookingId': diagnosticBookingId,
  ...
  // Helper method to get doctor name
  String get doctorName {
    return doctor?.name ?? doctorId?.name ?? name ?? 'Unknown Doctor';
  }

  // Helper method to get doctor qualification
  String get doctorQualification {
    return doctor?.qualification ?? doctorId?.qualification ?? description ?? 'Not specified';
  }

  // Helper method to get doctor specialization
  String get doctorSpecialization {
    return doctor?.specialization ?? doctorId?.specialization ?? 'Not specified';
  }
}

// NEW CLASS: BookedSlot
class BookedSlot {
  final String day;
  final String date;
  final String timeSlot;
...
// UPDATED: DoctorInfo class with new fields
class DoctorInfo {
  final String id;
  final String name;
  final String specialization;
