...
//   final String?id;
//   const LifeStyleQuiz({super.key,this.id});
...
//                   // Question
//                   const Text(
//                     '1. How many days per week do you do > 30 minutes of moderate exercise?',
//                     style: TextStyle(
//                       fontSize: 16,
...
//                   // Answer Options
//                   _buildRadioOption('5-7 days'),
//                   const SizedBox(height: 12),
//                   _buildRadioOption('1-4 days'),
//                   const SizedBox(height: 12),
//                   _buildRadioOption('Rarely or never'),
//                 ],
//               ),
//             ),
...
//                     onPressed: () {
//                       Navigator.push(context, MaterialPageRoute(builder: (context)=>LifeStyleQuiz2()));
//                     },
...
//                   fontWeight: selectedAnswer == value ? FontWeight.w500 : FontWeight.normal,
//                 ),
//               ),
//             ),
//             Radio<String>(
...
// class LifeStyleQuiz extends StatefulWidget {
//   final String? id;
//   final List<dynamic>? hraList; // Add this parameter to receive HRA list

//   const LifeStyleQuiz({super.key, this.id, this.hraList});
...
//                             context,
//                             MaterialPageRoute(
//                               builder: (context) => LifeStyleQuiz2(id: selectedHraName,),
//                             ),
//                           );
//                         },
//                         style: ElevatedButton.styleFrom(
...
//                             context,
//                             MaterialPageRoute(
//                               builder: (context) => LifeStyleQuiz2(
//                                 id: selectedHraName,
...
//   const LifeStyleQuiz({super.key, this.id, this.hraList,this.selectedHraId});
...
//         child: Consumer<HraQuestionsProvider>(
...
//           selectedAnswer = value;
//         });
//         // Save the answer to the provider
//         Provider.of<HraQuestionsProvider>(context, listen: false)
...
//       // All categories completed, navigate to results
//       Navigator.pushAndRemoveUntil(
//         context,
...
//         );
//       } else {
//         // Fallback: navigate to results if no uncompleted category found
//         Navigator.pushAndRemoveUntil(
//           context,
//           MaterialPageRoute(builder: (context) => const ResultScreen()),
//           (Route<dynamic> route) => false,
...
//                                       ? completedCategories.length / widget.hraList!.length
//                                       : 0,
//                                   backgroundColor: Colors.grey[200],
...
//                                         });
//                                       } else {
//                                         // Quiz completed - handle auto-navigation
...
//                             final hra = widget.hraList![index];
//                             final hraName = hra.hraName ?? 'Unknown HRA';
//                             final isCompleted = completedCategories.contains(hraName);
...
//                                   color: selectedHraName == hraName
//                                       ? Colors.blue[700]
//                                       : (isCompleted ? Colors.green[700] : Colors.black),
//                                 ),
//                               ),
//                               trailing: selectedHraName == hraName
//                                   ? Icon(
...
//     Set<String> willBeCompleted = Set.from(completedCategories)..add(selectedHraName);

//     if (widget.hraList != null && widget.hraList!.isNotEmpty) {
//       bool allWillBeCompleted = widget.hraList!.every((hra) =>
//           willBeCompleted.contains(hra.hraName ?? ''));
