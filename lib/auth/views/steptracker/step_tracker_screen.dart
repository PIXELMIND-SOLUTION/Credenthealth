          ...
          return RefreshIndicator(
            ...
            child: SingleChildScrollView(
              ...
              ProgressHistoryList(),
                    ...
                    //       child: _buildStatCard(
                    //         'Distance',
                    //         '${((trackerProvider.currentSteps * 0.762) / 1000).toStringAsFixed(2)} km',
                    //         Icons.straighten,
                    //         Colors.blue,
                    //       ),
                    //     ),
                    ...
                    //       child: _buildStatCard(
                    //         'Calories',
                    //         '${(trackerProvider.currentSteps * 0.04).toStringAsFixed(0)} kcal',
                    //         Icons.local_fire_department,
                    //         Colors.orange,
                    //       ),
                    //     ),
                    ...
                    //       child: _buildStatCard(
                    //         'Active Time',
                    //         '${(trackerProvider.currentSteps / 100).toStringAsFixed(0)} min',
                    //         Icons.timer,
                    //         Colors.green,
                    //       ),
                    //     ),
                    ...
                    //       child: _buildStatCard(
                    //         'Avg Speed',
                    //         '${(trackerProvider.currentSteps > 0 ? 4.5 : 0.0).toStringAsFixed(1)} km/h',
                    //         Icons.speed,
                    //         Colors.purple,
                    //       ),
                    //     ),
                    ...
                    //       SizedBox(
                    //         height: 120,
                    //         child: trackerProvider.progressHistory.isNotEmpty
                    //             ? Row(
                    //                 mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    //                 crossAxisAlignment: CrossAxisAlignment.end,
                    //                 children: _buildWeeklyChart(trackerProvider.progressHistory),
                    //               )
                    //             : const Center(
                    //                 child: Text(
                    //                   'No data available',
                    ...
                    //                 onPressed: () {
                    //                   trackerProvider.simulateSteps(10);
                    //                 },
                    ...
                    //               child: ElevatedButton(
                    //                 onPressed: () {
                    //                   trackerProvider.simulateSteps(50);
                    //                 },
                    //                 child: const Text('Add 50 Steps'),
                    //               ),
                    //             ),
                    //           ],
                    //         ),
