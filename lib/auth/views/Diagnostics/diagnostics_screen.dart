...
class _DiagnosticsScreenState extends State<DiagnosticsScreen> {
  ...
  Widget build(BuildContext context) {
    print(
        '🔍 meeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee widget.id ${widget.amount}');
    print(
        'heloooooooooooooooooooooooooooooooooooooooooooooooooooooooo ${widget.amount}');
    return Scaffold(
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // Show message if no booking options available
              if (diagnostic.homeCollectionSlots.isEmpty &&
                  diagnostic.centerVisitSlots.isEmpty)
                Container(
                  margin:
                      const EdgeInsets.symmetric(horizontal: 20, vertical: 16),
                  padding: const EdgeInsets.all(16),
