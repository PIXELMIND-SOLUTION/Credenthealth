...
// //   try {
// //     print('Raw date: ${bookingSlot.date}');
// //     print('Raw timeSlot: ${bookingSlot.timeSlot}');
...
//       final timeStr = bookingSlot.timeSlot;
//       final timeFormat = DateFormat('HH:mm'); // changed here
//       final timeOnly = timeFormat.parse(timeStr);
...
//       return '${bookingSlot.date} at ${bookingSlot.timeSlot}';
...
//       }
//     } else if (now.isAfter(appointmentDateTime) &&
...
//                 ],
//                 border:
//                     isActive ? Border.all(color: Colors.green, width: 2) : null,
//               ),
//               child: Material(
//                 color: Colors.white,
//                 borderRadius: BorderRadius.circular(12),
...
//                                       decoration: BoxDecoration(
//                                         color:
//                                             _getStatusColor(doctor.bookingSlot),
//                                         shape: BoxShape.circle,
//                                         border: Border.all(
//                                           color: Colors.white,
//                                           width: 2,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                Text(
                  'Use this chat to connect with your doctors during active appointment slots. Green status means you can chat now!',
                  style: TextStyle(
                    fontSize: 13,
                    color: Colors.black,
                    height: 1.3,
